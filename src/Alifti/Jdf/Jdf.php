...
// Jalali Date for Laravel
// Author : Ali Fattahi 
// Email  : Ali.robocup@gmail.com
// Base functions has been copied from "jdf.scr.ir" And ported to Laravel by Ali Fattahi
// 
...
/*	F	*/
	...
	public static function jcheckdate($jm,$jd,$jy){
	 $jm=Jdf::tr_num($jm); $jd=Jdf::tr_num($jd); $jy=Jdf::tr_num($jy);
	...
	public static function gregorian_to_jalali($g_y,$g_m,$g_d,$mod=''){
		$g_y=Jdf::tr_num($g_y); $g_m=Jdf::tr_num($g_m); $g_d=Jdf::tr_num($g_d);/* <= :اين سطر ، جزء تابع اصلي نيست */
	 $d_4=$g_y%4;
	...
	public static function jalali_to_gregorian($j_y,$j_m,$j_d,$mod=''){
		$j_y=Jdf::tr_num($j_y); $j_m=Jdf::tr_num($j_m); $j_d=Jdf::tr_num($j_d);/* <= :اين سطر ، جزء تابع اصلي نيست */
	 $d_4=($j_y+1)%4;
